...
public partial class SoloGamePage : Page
{
    ...
    private static readonly List<(string Text, string Category, string[] Options, int Correct, string Explanation)> _questions = new()
    {
        ...
        ("Как называется традиционный белорусский картофельный блин?", "Кухня",
        ...
        ("Сколько областей в Республике Беларусь?", "География",
            new[]{"5","6","7","8"}, 1, "В Беларуси 6 областей: Брестская, Витебская, Гомельская, Гродненская, Минская, Могилёвская."),
        ("Какой белорусский город называют «городом над Неманом»?", "География",
        ...
        ("Какой белорусский писатель написал роман «Знак беды»?", "Культура",
            new[]{"Янка Купала","Якуб Колас","Василь Быков","Иван Мележ"}, 2, "Василь Быков — выдающийся белорусский писатель."),
        ("Какова длина государственной границы Беларуси (примерно)?", "География",
    ...
    private void NextQuestion()
    {
        ...
        // Перемешать варианты (опционально — оставим исходный порядок для простоты)
    ...
    private async void EvaluateAnswer(int chosen)
    {
        ...
        // Бот: 65% шанс правильного ответа
